  ...
  return (
    <>
      <div className="relative flex flex-col items-center justify-center gap-[5px] md:gap-[90px] lg:gap-[120px] 2xl:gap-[120px]">
        <div className="flex mt-20 flex-col-reverse md:flex-row items-start md:items-end justify-between gap-5 w-[88%] md:w-[70%] mx-auto">
            ...
            <div className="flex space-x-2 xs:space-x-3 lg:space-x-4 items-center mr-auto">
              ...
              >
                ...
                >
                  <svg
                    ...
                    className="hover:fill-white transition-colors duration-300 w-8 h-8 lg:w-10 lg:h-10 xl:w-12 xl:h-12"
                  >
                    <path
              ...
              >
                <a
                  ...
                  className="hover:text-gray-300"
                  target="blank"
                  aria-label="TriggerX Network on X"
                >
                  <svg
                    width="40"
                    height="45"
                    ...
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                    className="hover:fill-white transition-colors duration-300 w-7 h-7 lg:w-8 lg:h-8 xl:w-10 xl:h-10"
                  >
                    <path
              ...
              >
                <a
                  ...
                  className="hover:text-gray-300"
                  target="blank"
                  aria-label="TriggerX Network on Telegram"
                >
                  <svg
                    width="46"
                    height="45"
                    ...
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                    className="hover:fill-white transition-colors duration-300 w-[27px] h-[27px] lg:w-8 lg:h-8 xl:w-10 xl:h-10"
                  >
                    <path
              ...
              >
                <a
                  ...
                  className="hover:text-gray-300"
                  target="blank"
                  aria-label="TriggerX Documentation on GitBook"
                >
                  <div className="border-[0.5px] lg:border border-white rounded-full hover:bg-white ">
                    <svg
                      width="42"
                      height="42"
                      viewBox="0 0 42 42"
                      fill="none"
                      xmlns="http://www.w3.org/2000/svg"
                      className="hover:fill-black transition-colors duration-300 w-[24px] h-[24px] lg:w-8 lg:h-8 xl:w-10 xl:h-10"
                    >
                      <path
              ...
              >
                <a
                  ...
                  className="hover:text-gray-300"
                  target="blank"
                  aria-label="TriggerX on Mirror"
                >
                  <div className="border border-white rounded-full group hover:bg-white p-1.5 lg:p-2">
                    <svg
                      width="20"
                      height="22"
                      viewBox="0 0 21 27"
                      fill="none"
                      xmlns="http://www.w3.org/2000/svg"
                      className="group-hover:fill-black transition-colors duration-300 w-3 h-3 lg:w-4 lg:h-4 xl:w-6 xl:h-6"
                    >
                      <path
              ...
              >
                ...
                >
                  <svg
                    ...
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                    className="hover:fill-white transition-colors duration-300 w-8 h-8 lg:w-10 lg:h-10 xl:w-12 lxl:h-12"
                  >
                    <path
                ...
                >
                  <div className="border border-white rounded-full group hover:bg-white p-1.5 lg:p-2">
                    <svg
                      ...
                      fill="none"
                      xmlns="http://www.w3.org/2000/svg"
                      className="group-hover:fill-black transition-colors duration-300 w-[14px] h-[14px] lg:w-4 lg:h-4 xl:w-6 xl:h-6"
                    >
                      <path
                        d="M37.7232 12.5947C37.5243 11.8536 37.134 11.1778 36.5913 10.6352C36.0487 10.0926 35.373 9.70222 34.6318 9.50331C32.6071 8.72106 12.9913 8.33781 7.30034 9.52519C6.5591 9.72417 5.88326 10.1147 5.34064 10.6574C4.79803 11.2002 4.40774 11.8761 4.20896 12.6174C3.29459 16.6276 3.22546 25.2971 4.23171 29.3973C4.43063 30.1384 4.82097 30.8142 5.36358 31.3568C5.90618 31.8994 6.58196 32.2898 7.32309 32.4887C11.3332 33.4118 30.3977 33.5413 34.6546 32.4887C35.3957 32.2898 36.0715 31.8994 36.6141 31.3568C37.1567 30.8142 37.547 30.1384 37.746 29.3973C38.7207 25.0284 38.7898 16.8962 37.7232 12.5947Z"
                        stroke="white"
                        strokeWidth="2"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      />
                      <path
                        d="M26.7466 20.996L17.6055 15.7539V26.2382L26.7466 20.996Z"
                        stroke="white"
                        strokeWidth="2"
                        strokeLinecap="round"
                        strokeLinejoin="round"
