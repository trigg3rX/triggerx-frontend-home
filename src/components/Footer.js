            ...
            <div className="flex space-x-4 items-center">
              ...
              >
                <svg
                  ...
                  className="hover:fill-white transition-colors duration-300 w-8 h-7 sm:w-7 sm:h-9 lg:w-12 lg:h-12"
                >
                  <path
              ...
              >
                <svg
                  ...
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                  className="transition-colors duration-300 w-6 h-6 sm:w-8 sm:h-8 lg:w-10 lg:h-10"
                >
                  <rect
                    x="0.197627"
                    y="0.197627"
...
<a
             ...
             <svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg"                     className="hover:fill-white transition-colors duration-300 w-6 h-6 sm:w-8 sm:h-8 lg:w-10 lg:h-10">
<path d="M30.0004 32.7369V32.9322H30.1957V32.7369H30.0004ZM12 32.7369H11.8047V32.9322H12V32.7369ZM12 17.9828V17.7875H11.8047V17.9828H12ZM12 17.9828V18.1781H12.195L12.1953 17.9831L12 17.9828ZM30.0004 17.9828L29.8051 17.9831L29.8055 18.1781H30.0004V17.9828ZM30.0004 17.9828H30.1957V17.7875H30.0004V17.9828ZM29.8051 17.9997V32.7369H30.1957V17.9997H29.8051ZM30.0004 32.5416H12V32.9322H30.0004V32.5416ZM12.1953 32.7369V17.9997H11.8047V32.7369H12.1953ZM12.1953 17.9997V17.9828H11.8047V17.9997H12.1953ZM12 18.1781H12V17.7875H12V18.1781ZM12.1953 17.9831C12.2042 13.1282 16.1429 9.1953 21.0002 9.1953V8.8047C15.9274 8.8047 11.814 12.9121 11.8047 17.9824L12.1953 17.9831ZM21.0002 9.1953C25.8575 9.1953 29.7962 13.1282 29.8051 17.9831L30.1957 17.9824C30.1864 12.9121 26.073 8.8047 21.0002 8.8047V9.1953ZM30.0004 18.1781H30.0004V17.7875H30.0004V18.1781ZM29.8051 17.9828V17.9997H30.1957V17.9828H29.8051Z"                       stroke="white"
/>
</svg>
</div>
...
<a
                ...
                target="blank"
              >
              <svg width="46" height="45" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg"                   className="hover:fill-white transition-colors duration-300 w-6 h-6 sm:w-8 sm:h-8 lg:w-12 lg:h-12"
              >
<path d="M22.757 21C22.757 25.3015 19.292 28.7875 15.022 28.7875C10.7485 28.7875 7.28525 25.3015 7.28525 21C7.28525 16.6985 10.7503 13.2107 15.0203 13.2107C19.2938 13.2107 22.757 16.6985 22.757 20.9982M38.5 21C38.5 11.34 30.66 3.5 21 3.5C11.34 3.5 3.5 11.34 3.5 21C3.5 30.66 11.34 38.5 21 38.5C30.66 38.5 38.5 30.6583 38.5 21ZM31.2445 20.9982C31.2445 25.0477 29.512 28.3307 27.377 28.3307C25.2385 28.3307 23.5077 25.0477 23.5077 20.9982C23.5077 16.9487 25.2402 13.6658 27.3752 13.6658C29.5102 13.6658 31.2445 16.947 31.2445 20.9982ZM34.713 20.9982C34.713 24.6242 34.104 27.5678 33.3533 27.5678C32.6025 27.5678 31.9918 24.626 31.9918 20.9982C31.9918 17.3705 32.6008 14.4287 33.3533 14.4287C34.104 14.4287 34.713 17.3687 34.713 20.9982Z" stroke="white" stroke-width="0.5"/>
</svg>
</a>
            </div>
