  ...
  return (
    <>
      <div className="relative flex flex-col items-center justify-center gap-[10px] sm:gap-[90px] lg:gap-[120px] 2xl:gap-[180px]">
        <div className="flex mt-20 flex-col-reverse sm:flex-row items-start sm:items-end justify-between gap-10 sm:gap-5 w-[80%] mx-auto">
        ...
        <Image
          src={footer1}
          alt=""
          className="absolute left-0 -z-10 bottom-[75%] sm:bottom-[26%] lg:bottom-[45%] w-[80px] sm:w-[130px] lg:w-[150px] 2xl:w-[200px] h-auto"
        />

        <Image
          src={footer2}
          alt=""
          className="absolute right-[0%] sm:right-0 -z-10 bottom-[60%] sm:bottom-[50%] lg:bottom-[55%] w-[80px] sm:w-[130px] 2xl:w-[220px] h-auto"
        />
      </div>
    </>
  );
